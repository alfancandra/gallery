                    ...
                    <form action="<?php echo e(route('adm.storephoto')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" name="images[]" multiple="multiple" type="file" id="formFile" required>
...
<?php echo $__env->make('admin.template.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\website\Pameran\resources\views/admin/photo/add.blade.php ENDPATH**/ ?>
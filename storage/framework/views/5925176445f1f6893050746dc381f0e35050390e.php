                    ...
                    <div class="col-md-12">
                        ...
                        <div class="single-blog-post">
                            <?php foreach (json_decode($photo->images) as $image) { ?>
                                <br><img src="<?php echo e(asset('img/photo/'.$image)); ?>" alt=""><br>
                            <?php } ?>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\website\Pameran\resources\views/photo/description.blade.php ENDPATH**/ ?>